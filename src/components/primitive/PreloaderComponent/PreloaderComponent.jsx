...
import './PreloaderComponent.sass';

const PreloaderComponent = (props) => {
    const color = props.color || '#8f8f8f';
    const iconSize = props.iconSize || '48px';
    ...
    return (
        <div style={computedStyle} className="preloader">
            <svg width={iconSize} height={iconSize} version="1.1" id="L7" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 100 100" enableBackground="new 0 0 100 100">
